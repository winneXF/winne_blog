<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:109:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\book_recommend\book_recommend_list.html";i:1526630366;s:75:"E:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"E:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1526632909;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>推荐书籍列表</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a href="#">书籍推荐管理</a></li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
...
<button type="button" tooltip="添加书籍推荐" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('book_recommend/book_recommend_add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center">书籍推荐名称</th>
                                <th class="text-center">书籍所属推荐版块</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <?php if($vo['book_type'] == 1): ?>
                                    HTML/CSS
                                    <?php elseif($vo['book_type'] == 2): ?>
                                    JavaScript
                                    <?php elseif($vo['book_type'] == 3): ?>
                                    休闲书籍
                                    <?php endif; ?>
                                </td>
                                <td align="center">
                                ...
                                <td align="center"><?php echo $vo['book_time']; ?></td>
                                <td align="center">
                                    <?php if($vo['pic'] != ''): ?>
                                ...
                                <td align="center">
                                    <a href="<?php echo url('book_recommend/book_recommend_edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('book_recommend/book_recommend_del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
