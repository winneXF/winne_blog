<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:103:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\friend_link\friend_link_list.html";i:1526630396;s:75:"E:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"E:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1526632909;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>友情链接列表</title>
...
<button type="button" tooltip="添加友情链接" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('friend_link/friend_link_add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center">友情链接地址</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a href="<?php echo url('friend_link/friend_link_edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('friend_link/friend_link_del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
