<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\login\login.html";i:1526630413;}*/ ?>
<!DOCTYPE html>
        ...
        <!-- <form action="" method="post"> -->
            <div class="loginbox bg-white">
                ...
                <div class="loginbox-textbox">
                    <input value="" id="admin-name" autofocus class="form-control" placeholder="请输入管理员账号" name="adminname" type="text">
                </div>
                <div class="loginbox-textbox">
