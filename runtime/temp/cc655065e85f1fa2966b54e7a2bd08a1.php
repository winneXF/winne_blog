<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:101:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\tools_name\tools_name_list.html";i:1524557798;s:75:"E:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"E:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1524792066;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>list</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a href="#">工具Tab名称管理</a></li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
...
<button type="button" tooltip="添加工具Tab名称" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('tools_name/tools_name_add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center">工具Tab名称</th>
                                <th class="text-center">工具Tab背景图</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <?php if($vo['bg_url'] != ''): ?>
                                    <img src="__IMG__<?php echo $vo['bg_url']; ?>" height="80">
                                    <?php else: ?>
                                    暂无背景图
                                    <?php endif; ?>
                                </td>
                                <td align="center">
                                    <a href="<?php echo url('tools_name/tools_name_edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('tools_name/tools_name_del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
