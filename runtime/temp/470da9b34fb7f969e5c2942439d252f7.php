<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"F:\website\php.travel.com\winne_blog\public/../application/admin\view\nav\nav_add.html";i:1524194749;s:75:"F:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"F:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1524792066;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>add</title>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">新增导航栏目</span>
            </div>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" autocomplete="off" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="nav_name" placeholder="" name="nav_name" required="" type="text">
                            </div>
