<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:101:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\tools_name\tools_name_edit.html";i:1524558667;s:75:"E:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"E:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1524792066;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>edit</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                             <a href="<?php echo url('tools_name/tools_name_list'); ?>">工具Tab名称管理</a>
                        </li>
                        <li class="active">修改工具Tab名称</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改工具Tab名称</span>
            </div>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form"  enctype="multipart/form-data" action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="tabname" class="col-sm-2 control-label no-padding-right">工具Tab名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="tabname" placeholder="" name="tabname" required="" type="text" value="<?php echo $tools_names['tabname']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            <label for="bg_url" class="col-sm-2 control-label no-padding-right">Tab工具背景图</label>
                            <div class="col-sm-6">
                                <input id="bg_url" placeholder="" name="bg_url"  type="file" style="display: inline;">
                                <?php if($tools_names['bg_url'] != ''): ?>
                                    <img src="__IMG__<?php echo $tools_names['bg_url']; ?>" height="80">
                                <?php else: ?>
                                    <span>暂无背景图</span>
                                <?php endif; ?>
                            </div>
