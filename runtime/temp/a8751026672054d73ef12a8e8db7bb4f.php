<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"E:\website\php.travel.com\winne_blog\public/../application/index\view\search\search.html";i:1526279764;s:85:"E:\website\php.travel.com\winne_blog\application\index\view\common\detail_header.html";i:1525316601;s:78:"E:\website\php.travel.com\winne_blog\application\index\view\common\footer.html";i:1523860798;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>winne文章搜索</title>
  ...
  <div id="main" class="main-content">
    <div id="mainContent" class="left-content">
        <div class="forFlow">
          <?php if($keywords != ''): ?> 
            <!-- 搜索主体内容信息 -->
          <p class="search-keywords">搜索“<span><?php echo $keywords; ?></span>”相关文章：</p>
          <div class="search-content">
          <?php if($searchres != ['']): foreach($searchres as $item): ?>
            <article class="article clear">
                <div class="article-top">
                    <h2><a href="<?php echo url('article/index',array('article_id' => $item['id'])); ?>"><?php echo $item['title']; ?></a>
                    </h2>
                </div>
          ...
          <?php else: ?>          
            <div class="none-article">暂无相关文章</div>
          <?php endif; ?>
