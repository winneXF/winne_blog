<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:93:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\replay\replay_list.html";i:1526630481;s:75:"E:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"E:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1526632909;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>回复信息列表</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a href="#">回复管理</a></li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center">几楼评论的相关回复</th>
                                <th class="text-center">回复者用户名</th>
                                <th class="text-center">回复目标用户名</th>
                        ...
                        <tbody>
                            <?php foreach($replays as $vo): ?> 
                            <tr>
                                <td align="center"><?php echo $vo['id']; ?></td>
                                <td align="center"><?php echo $vo['comment_id']; ?></td>
                                <td align="center"><?php echo $vo['from_name']; ?></td>
                                <td align="center"><?php echo $vo['to_name']; ?></td>
                                <td align="center"><?php echo $vo['replay_content']; ?></td>
                                <td align="center"><?php echo $vo['replay_time']; ?></td>
                               
                                <td align="center">
                                    <a href="<?php echo url('replay/replay_edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('replay/replay_del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
