    ...
    <div class="main-wrapper clear">
        ...
        <!--  精彩推荐 3D旋转 start    -->
            <div class="hot-news clear">
                ...
                <div class="hot-change clear">
                    <div class="side-img">
                        <img class="active" src="__PUBLIC__images/hotNew3333.png" alt="互联网跨界融合-大势所趋" title="互联网跨界融合-大势所趋" />
                        <img src="__PUBLIC__images/hotNew4444.png" alt="web、animation、design、creative" title="web-creative" />
                        <img src="__PUBLIC__images/hotNew1111.png" alt="web前端入门须知" title="web前端入门须知" />
                        <img src="__PUBLIC__images/hotNew2222.png" alt="CSS" title="CSS" />
                    </div>
                    <div class="box">
                        <div class="side-img-show">
                            <img src="__PUBLIC__images/hotNew111.png" alt="web前端入门须知" title="web前端入门须知" />
                            <img src="__PUBLIC__images/hotNew444.png" alt="web、animation、design、creative" title="web-creative" />
                            <img src="__PUBLIC__images/hotNew333.png" alt="互联网跨界融合-大势所趋" title="互联网跨界融合-大势所趋" />
                            <img src="__PUBLIC__images/hotNew222.png" alt="CSS" title="CSS" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="basic-book">
                ...
                <div class="html-css-list">
                    ...
                    <div class="book1">
                        <img src="<?php if($item['pic'] != ''): ?>__IMG__<?php echo $item['pic']; else: ?>__PUBLIC__images/error.png<?php endif; ?>" alt="<?php echo $item['bookname']; ?>" title="<?php echo $item['bookname']; ?>" />
                        <p>
            ...
            <div id="js-book">
                ...
                <div class="js-content">
                    ...
                    <div>
                        <figure>
                           <div class="light"></div>
                           <img src="<?php if($item['pic'] != ''): ?>__IMG__<?php echo $item['pic']; else: ?>__PUBLIC__images/error.png<?php endif; ?>" alt="<?php echo $item['bookname']; ?>" />
        ...
        <!--  扫一扫 start    -->
            <div class="friends">
                ...
                <div class="chat-methods">
                    <img src="__PUBLIC__images/WeChat.png" alt="wechat" />
                    <img style="display: none;" src="__PUBLIC__images/qq.png" alt="QQ" />
                </div>
            </div>
            <!--  扫一扫 end    -->
            <!--  工具手册 start    -->
        ...
        <div id="movie">
            ...
            <div class="movie-show clear">
                ...
                <img src="<?php if($movie_top_show['pic'] != ''): ?>__IMG__<?php echo $movie_top_show['pic']; else: ?>__PUBLIC__images/error.png<?php endif; ?>" alt="<?php echo $movie_top_show['title']; ?>" title="<?php echo $movie_top_show['title']; ?>" />
                <p>
        ...
        <div id="like-books">      
            ...
            <div class="movie-show clear">
                ...
                <img src="<?php if($book_top_show['pic'] != ''): ?>__IMG__<?php echo $book_top_show['pic']; else: ?>__PUBLIC__images/error.png<?php endif; ?>" alt="<?php echo $book_top_show['bookname']; ?>" title="<?php echo $book_top_show['bookname']; ?>" />
                <p>
        ...
        <div id="HTML5-games">
            <ul class="clear">
                <li>
                    <figure>
        <img src="__PUBLIC__images/game1.png" alt="HTML5版切水果游戏" />
        <figcaption><a href="<?php echo url('HtmlGames/fruit_cut'); ?>" target="_blank">HTML5版切水果游戏</a></figcaption>
        </figure>
                </li>
                <li>
                    <figure>
        <img src="__PUBLIC__images/game2.png" alt="HTML5猜杯子小游戏" />
        <figcaption><a href="<?php echo url('HtmlGames/guessing_cup'); ?>" target="_blank">HTML5猜杯子小游戏</a></figcaption>
        </figure>
                </li>
                <li>
                    <figure>
        <img src="__PUBLIC__images/game3.png" alt="HTML5五子棋游戏" />
        <figcaption><a href="<?php echo url('HtmlGames/gobang'); ?>" target="_blank">HTML5五子棋游戏</a></figcaption>
        </figure>
                </li>
                <li>
                    <figure>
        <img src="__PUBLIC__images/game4.png" alt="HTML5小人推箱子小游戏" />
        <figcaption><a href="<?php echo url('HtmlGames/snake'); ?>" target="_blank">HTML5贪吃蛇小游戏</a></figcaption>
        </figure>
                </li>
                <li>
                    <figure>
        <img src="__PUBLIC__images/game5.png" alt="HTML5吃豆人游戏" />
        <figcaption><a href="<?php echo url('HtmlGames/pcman'); ?>" target="_blank">HTML5吃豆人游戏</a></figcaption>
        </figure>
                </li>
                <li>
                    <figure>
        <img src="__PUBLIC__images/game6.png" alt="HTML5重力感应游戏" />
        <figcaption><a href="<?php echo url('HtmlGames/gravity'); ?>" target="_blank">HTML5重力感应游戏</a></figcaption>
        </figure>
                </li>
            </ul>
