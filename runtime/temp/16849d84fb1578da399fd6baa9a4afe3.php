<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"F:\website\php.travel.com\winne_blog\public/../application/admin\view\nav\nav_list.html";i:1524064783;s:75:"F:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"F:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1524792066;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>list</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a href="#">导航栏目管理</a></li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
...
<button type="button" tooltip="添加导航栏目" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('nav/nav_add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center">导航栏目名称</th>
                                <th class="text-center">导航栏目所属级数</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a href="<?php echo url('nav/nav_edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('nav/nav_del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
