<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:96:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\comments\comments_add.html";i:1524192551;s:75:"E:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"E:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1524204717;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>add</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo url('comments/comments_list'); ?>">留言管理</a>
                        </li>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">新增留言</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                        <div class="form-group">
                            <label for="title" class="col-sm-2 control-label no-padding-right">留言标题</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="title_anchor_id" class="col-sm-2 control-label no-padding-right">留言标题锚点id</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="title_anchor_id" placeholder="" name="title_anchor_id"  type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>

                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">留言作者</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">留言描述</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="belong_nav" id="first-nav">
                                ...
                                <select name="navid" id="second-nav">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                 <label>
                                    <input class="checkbox-slider colored-darkorange" name="comments_state" type="checkbox">
                                    <span class="text"></span>
                                 </label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">留言内容</label>
                            <div class="col-sm-6">
                                 <label>
