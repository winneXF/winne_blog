<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:106:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\tools_content\tools_content_add.html";i:1524559134;s:75:"E:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"E:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1524792066;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>add</title>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">新增工具Tab内容</span>
            </div>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" enctype="multipart/form-data" role="form" autocomplete="off" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input required="" class="form-control" id="name" placeholder="" name="name" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select required="" class="form-control" name="tabid" id="first-nav">
                                    ...
                                    <option value="<?php echo $vo['id']; ?>"><?php echo $vo['tabname']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="soft_size" placeholder="" name="soft_size" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="version" class="col-sm-2 control-label no-padding-right">软件版本</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="version" placeholder="" name="version" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <!-- <div class="form-group">
                            <label for="bg_url" class="col-sm-2 control-label no-padding-right">背景图</label>
                            <div class="col-sm-6">
                                <input id="bg_url" placeholder="" name="bg_url"  type="file" style="display: inline;">
                            </div>
                        </div> -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                 <label>
                                    <textarea name="soft_content"  id="soft_content"></textarea>
                                 </label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                    <textarea class="form-control" name="soft_desc"  id="soft_desc"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
