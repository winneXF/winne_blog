<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"F:\website\php.travel.com\winne_blog\public/../application/admin\view\nav\nav_edit.html";i:1524194797;s:75:"F:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"F:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1524792066;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>edit</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                             <a href="<?php echo url('nav/nav_list'); ?>">导航栏目管理</a>
                        </li>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改导航栏目</span>
            </div>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="nav_name" class="col-sm-2 control-label no-padding-right">导航栏目名</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="nav_name" placeholder="" name="nav_name" required="" type="text" value="<?php echo $nav['nav_name']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        
                        <div class="form-group">
                            <label for="password" class="col-sm-2 control-label no-padding-right">导航栏目所属的一级</label>
                            <div class="col-sm-6">
                                <select required="" class="form-control" name="fatherid" id="first-nav">
                                    <?php if($nav['fatherid'] != 0): ?>
                                    ...
                                    <option <?php if($vo['id'] == $nav['fatherid']): ?>selected="selected"<?php endif; ?> value="<?php echo $vo['id']; ?>"><?php echo $vo['nav_name']; ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; elseif($nav['fatherid'] == 0): ?>
                                    <option value="0">已属于第一级导航（不许再选择）</option>
                                    <?php endif; ?> 
                                </select>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
