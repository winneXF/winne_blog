<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:100:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\tools_name\tools_name_add.html";i:1524558661;s:75:"E:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"E:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1524204717;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>add</title>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">新增工具Tab名称</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form"  enctype="multipart/form-data" autocomplete="off" action="" method="post">
                        <div class="form-group">
                            <label for="tabname" class="col-sm-2 control-label no-padding-right">工具Tab名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="tabname" placeholder="" name="tabname" required="" type="text">
                            </div>
