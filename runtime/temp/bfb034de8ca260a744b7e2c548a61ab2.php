<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:93:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\manager\admin_list.html";i:1524017330;s:75:"E:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524016586;s:76:"E:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1524016915;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>list</title>
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('manager/addF'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td align="center">
                                    <a href="admin_edit.html" class="btn btn-primary btn-sm shiny">
