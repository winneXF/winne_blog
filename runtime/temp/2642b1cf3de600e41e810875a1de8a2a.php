<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\user\user_edit.html";i:1526630525;s:75:"E:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"E:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1526632909;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>修改用户</title>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="username" required="" type="text" value="<?php echo $users['username']; ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <p class="help-block col-sm-4 red">* （不填时为保留原密码）</p>
                        </div> 
                        <div class="form-group">
                            <label for="phone" class="col-sm-2 control-label no-padding-right">手机号</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="phone" placeholder="" name="phone" type="text" value="<?php echo $users['phone']; ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="email" placeholder="" name="email" type="text" value="<?php echo $users['email']; ?>">
                            </div>
                            
                        </div>
                        <div class="form-group">
                            <label for="state" class="col-sm-2 control-label no-padding-right">是否禁用</label>
                            <div class="col-sm-6">
                                 <label>
                                    <input <?php if($users['state'] == 0): ?>checked="checked"<?php endif; ?> class="checkbox-slider colored-darkorange" name="state" type="checkbox">
