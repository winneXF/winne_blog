<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:94:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\article\article_add.html";i:1526632178;s:75:"E:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"E:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1526632909;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>添加文章</title>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="title_anchor_id" placeholder="" name="title_anchor_id"  type="text" required="">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                 <label>
                                    <input class="checkbox-slider colored-darkorange" name="article_state" type="checkbox">
