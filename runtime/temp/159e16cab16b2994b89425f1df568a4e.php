<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:103:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\friend_link\friend_link_edit.html";i:1525856374;s:75:"E:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"E:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1526270319;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>修改友情链接</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                             <a href="<?php echo url('friend_link/friend_link_list'); ?>">友情链接管理</a>
                        </li>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="link_name" class="col-sm-2 control-label no-padding-right">友情链接名</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="link_name" placeholder="" name="link_name" required="" type="text" value="<?php echo $friend_links['link_name']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>

                        <div class="form-group">
                            <label for="url" class="col-sm-2 control-label no-padding-right">友情链接地址</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="url" placeholder="" name="url" required="" type="text" value="<?php echo $friend_links['url']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div> 
                        <div class="form-group">
