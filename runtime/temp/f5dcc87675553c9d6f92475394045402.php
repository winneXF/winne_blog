<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:97:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\comments\comments_edit.html";i:1525856338;s:75:"E:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"E:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1524792066;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
    <title>修改评论</title>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改留言</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    ...
                    <input type="hidden" name="id" value="">                        
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input id="pic" placeholder="" name="pic" style="display:inline;"  type="file">
                                    <?php if($comments['pic'] != ''): ?>
                                    <img src="__IMG__<?php echo $comments['pic']; ?>" height="80">
                                    <?php else: ?>
                                    未更换头像
                                    <?php endif; ?>
                        ...
                        <div class="form-group">
                            <label for="up_num" class="col-sm-2 control-label no-padding-right">被赞次数</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="up_num" type="text" name="up_num" value="<?php echo $comments['up_num']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="content" class="col-sm-2 control-label no-padding-right">留言内容</label>
                            <div class="col-sm-6">
                                    <textarea style="height: 80px;" class="form-control" name="content"  id="content"><?php echo $comments['content']; ?></textarea>
                            </div>
                        </div>
