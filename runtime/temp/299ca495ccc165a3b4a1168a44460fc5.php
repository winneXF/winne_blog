                    ...
                    <input type="hidden" name="id" value="<?php echo $articles['id']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if($articles['pic'] != ''): ?>
                                    <img src="__IMG__<?php echo $articles['pic']; ?>" height="80">
                                <?php else: ?>
                                    <span>暂无缩略图</span>
                                <?php endif; ?>
                            </div>
