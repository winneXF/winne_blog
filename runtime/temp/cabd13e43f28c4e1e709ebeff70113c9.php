<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"F:\website\php.travel.com\winne_blog\public/../application/index\view\register\register.html";i:1524624558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8" />
        	...
        	<form>
              <div>
                ...
                <div class="register-textbox clear">
                    ...
                    <img class="register-code"  src="<?php echo captcha_src(); ?>" alt="captcha" onclick="this.src='<?php echo captcha_src(); ?>?'+Math.random();" />
