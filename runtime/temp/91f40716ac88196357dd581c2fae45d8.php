<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:107:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\tools_content\tools_content_list.html";i:1525856732;s:75:"E:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"E:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1526270319;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>工具软件列表</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a href="#">工具Tab内容管理</a></li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
...
<button type="button" tooltip="添加工具Tab内容" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('tools_content/tools_content_add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center">工具名称</th>
                                <th class="text-center">工具所属tab类型</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><?php echo $vo['tabname']; ?></td>
                                <td align="center">
                                    <?php if($vo['state'] == 1): ?>
                                    已推荐
                                ...
                                <td align="center"><?php echo $vo['download_url']; ?></td>
                                ...
                                <td align="center">
                                    <a href="<?php echo url('tools_content/tools_content_edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('tools_content/tools_content_del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
