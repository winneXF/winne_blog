<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"E:\website\php.travel.com\winne_blog\public/../application/index\view\login\login.html";i:1526440167;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8" />
        ...
        <div id="reg-detail">
        	<form>
              <div>
                ...
                <input autofocus id="username" type="text"><b style="color:red;">*</b>
                <p><i class="iconfont icon-tishi"></i>用户名由中文、字母、数字、_和.组成 </p>
              </div>
                <div class="password-wrap">
                  <label for="psw">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码:</label>
                  <!-- <input type="password"  id="psw"> -->
                  <input type="password" id="psw" class="newPass cs_password pass-p"/>
                  <input style="display:none" type="text" class="newPass cs_password pass-t"/>
                  <i class="passeye iconfont icon-in_biyan"></i>
                  <b style="color:red;">*</b>
                  <p><i class="iconfont icon-tishi"></i>6-20位字符。由字母、数字和_组成。</p>
                </div> 
                <!-- <i class="iconfont icon-in_zhengyan"> -->
                <!-- <div>
