                ...
                <div id="horizontal-form">
                    ...
                    <input type="hidden" name="id">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="download_url" placeholder="" name="download_url" type="text" value="<?php echo $tools_contents['download_url']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
