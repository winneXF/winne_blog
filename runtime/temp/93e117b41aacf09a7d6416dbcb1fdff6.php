<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\movie\movie_edit.html";i:1525919156;s:75:"E:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"E:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1524792066;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>修改电影信息</title>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改电影推荐</span>
            </div>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" required="" id="title" placeholder="" name="title"  type="text" value="<?php echo $movies['title']; ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="movie_time" placeholder="" name="movie_time"  type="text" value="<?php echo $movies['movie_time']; ?>">
                            </div>
                        </div>  
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="language" placeholder="" name="language"  type="text" value="<?php echo $movies['language']; ?>">
                            </div>
                        </div>  
                        <div class="form-group">
                            <label for="recommend_num" class="col-sm-2 control-label no-padding-right">推荐指数</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="recommend_num" placeholder="" name="recommend_num"  type="text" value="<?php echo $movies['recommend_num']; ?>">
                            </div>
                        </div>  
                        <div class="form-group">
                            <label for="movie_type" class="col-sm-2 control-label no-padding-right">电影类型</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="movie_type" placeholder="" name="movie_type"  type="text" value="<?php echo $movies['movie_type']; ?>">
                            </div>
                        </div> 
                         <div class="form-group">
                            <label for="download_url" class="col-sm-2 control-label no-padding-right">下载地址</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="download_url" placeholder="" name="download_url"  type="text" value="<?php echo $movies['download_url']; ?>">
                            </div>
                        </div> 
                        <div class="form-group">
                            <label for="download_desc" class="col-sm-2 control-label no-padding-right">推荐下载说明</label>
                            <div class="col-sm-6">
                                <textarea name="download_desc" class="form-control"><?php echo $movies['download_desc']; ?></textarea>
                            </div>
                        </div>
                        <?php if($movies['state'] == 2): ?>
                        <div class="form-group">
                            <label for="top_desc" class="col-sm-2 control-label no-padding-right">首页电影的简介</label>
                            <div class="col-sm-6">
                                <textarea name="top_desc" class="form-control"><?php echo $movies['top_desc']; ?></textarea>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if($movies['pic'] != ''): ?>
                                    <img id="img-view" src="__IMG__<?php echo $movies['pic']; ?>" height="80">
                                <?php else: ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                 <label>
                                    <input <?php if($movies['state'] == 1): ?>checked="checked"<?php endif; ?> class="checkbox-slider colored-darkorange" name="state" type="checkbox">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                 <label>
                                    <input <?php if($movies['state'] == 2): ?>checked="checked"<?php endif; ?> id="indexstate" class="checkbox-slider colored-darkorange" name="indexstate" type="checkbox">
                                    <span class="text"></span>
                                 </label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                 <label>
                                    <textarea name="movie_content"  id="movie_content"><?php echo $movies['movie_content']; ?></textarea>
                                 </label>
                            </div>
                        </div>
                        <div class="form-group">
