<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:93:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\replay\replay_edit.html";i:1524796476;s:75:"E:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"E:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1524792066;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
    <title>edit</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo url('replay/replay_list'); ?>">回复管理</a>
                        </li>
                        <li class="active">修改回复</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改回复</span>
            </div>
                ...
                <div id="horizontal-form">
                    ...
                    <input type="hidden" name="id" value="">                        
                        ...
                        <div class="form-group">
                            <label for="replay_content" class="col-sm-2 control-label no-padding-right">回复内容</label>
                            <div class="col-sm-6">
                                    <textarea style="height: 100px;" class="form-control" name="replay_content"  id="replay_content"><?php echo $replays['replay_content']; ?></textarea>
                            </div>
                        </div>
