<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\admin\admin_edit.html";i:1526630236;s:75:"E:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"E:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1526632909;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>修改管理员</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                             <a href="<?php echo url('admin/admin_list'); ?>">管理员管理</a>
                        </li>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="adminname" class="col-sm-2 control-label no-padding-right">管理员名</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="adminname" placeholder="" name="adminname" required="" type="text" value="<?php echo $admins['adminname']; ?>">
                            </div>
