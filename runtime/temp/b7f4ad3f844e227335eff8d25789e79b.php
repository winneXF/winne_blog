<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:108:"E:\website\php.travel.com\winne_blog\public/../application/admin\view\article_anchor\article_anchor_add.html";i:1525856247;s:75:"E:\website\php.travel.com\winne_blog\application\admin\view\common\top.html";i:1524193502;s:76:"E:\website\php.travel.com\winne_blog\application\admin\view\common\left.html";i:1526270319;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>添加文章锚点</title>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">新增文章锚点</span>
            </div>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" autocomplete="off" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select required="" class="form-control" name="article_id" id="first-nav">
                                    ...
                                    <?php if(is_array($article_title) || $article_title instanceof \think\Collection || $article_title instanceof \think\Paginator): $i = 0; $__LIST__ = $article_title;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input required="" class="form-control" id="id_name" placeholder="" name="id_name" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                            <textarea required="" class="form-control" id="anchor_name" name="anchor_name"></textarea>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
