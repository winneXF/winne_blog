<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"E:\website\php.travel.com\winne_blog\public/../application/index\view\html_games\gobang.html";i:1524548931;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
		...
		<link rel="stylesheet" type="text/css" href="__PUBLIC__css/gobang.css" />
	</head>
	...
	<body>
		...
		<div style="width: 100%;height: 100%;" class="bb">
			...
			<div class="pnl startpnl">
				<div class="inputinfo">
					<img src="__PUBLIC__images/gobang/logo.png" width="100%" height="140" />
					<div class="box">
						<h3>选手</h3>
					...
					<div class="box">
						<h3>棋子类型</h3>
						<label for="ct2">仿真棋子 <img src="__PUBLIC__images/gobang/playA.png" width="20" height="20"/><img src="__PUBLIC__images/gobang/playB.png" width="20" height="20"/></label> <input type="radio" checked="checked" name="chesstype" value="2" id="ct2" />
					...
					<div class="box">
						...
						<label for="cbg2"><img src="__PUBLIC__images/gobang/bg1.jpg"   width="100" height="50"/></label>
						<input type="radio" name="chessbg" value="" src="__PUBLIC__images/gobang/bg1.jpg" id="cbg2" />
						<label for="cbg2"><img src="__PUBLIC__images/gobang/bg2.jpg"   width="100" height="50"/></label>
						<input type="radio" name="chessbg" value="" src="__PUBLIC__images/gobang/bg2.jpg" id="cbg2" />
						<label for="cbg3"><img src="__PUBLIC__images/gobang/bg3.jpg" width="100" height="50"/></label>
						<input type="radio" name="chessbg" value="" src="__PUBLIC__images/gobang/bg3.jpg" id="cbg3" />
			...
			<div id="winer" class="pnl winer">
				<img src="__PUBLIC__images/gobang/winer.jpeg" width="600" height="600" />
	...
	<script src="__PUBLIC__js/gobang.js" type="text/javascript" charset="utf-8"></script>
		...
		document.getElementById("startgame").addEventListener("click", function() {
			...
			function initParams() {
				...
				return {
					...
					playAImg: src="__PUBLIC__images/gobang/playA.png",
					playBImg: src="__PUBLIC__images/gobang/playB.png",
